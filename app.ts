...
app.get('/player', (req: express.Request, res: express.Response): void => {
	res.json({
		height: 1280,
		html: `<iframe class="streamable-embed" src="https://storage.googleapis.com/knock-extension/test-video.mp4" frameborder="0" scrolling="no" width="720" height="1280" allowfullscreen></iframe>`,
